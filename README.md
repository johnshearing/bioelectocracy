...
You could see a dog and think, "Oh! A collection of cells". You could then study all of the cells in the dog and never discover all the wonderful things that dogs can do such as rounding up sheep, pulling sleds. In order to make use of the things that dogs can do, you need to appreciate the dog as a whole and interact with it as a whole rather than looking at it as a collection of cells. If we want a dog to pull a sled, we don't try and control the dog at the cellular level, rather we just train the dog and then we let the dog command it's own cells in order to accomplish the task. Then there are some things that dogs do for us which require no training at all. These include guarding our homes or just being a friend. Finally, there is one special thing that dogs do which we don't often think of - Dogs take care of their own bodies (their cells). They look for food, water, shelter, and such for the benefit of their own cells. This ability of the dog as a whole to care for it's parts, and moreover, to solve problems that the parts know nothing about is a wonderful example of collective intelligence. We know that a dog's intelligence is collective because it's not located at any particular spot in the dog's body or brain. Rather, a dog's intelligence emerges as a result of all the cells in its body and brain communicating with each other.  

Like the dog, there are many things that collections of humans do that you would never discover if you just study humans as individuals. Markets, Governments, Industries, Cities, Transportation and communication networks are all examples of the wonderful things that groups of humans do. Again, like the dog, you don't control these collective human activities by controlling idividual humans. Rather these activities are controlled by setting group policy on minds, markets, and money. In other words, we act upon the group as a whole using policy and then let the group command the individual humans to achieve the desired results.   

Again, like the dog, there is one thing that groups of humans do as a collective which requires no training at all - that is caring for individual humans.  
