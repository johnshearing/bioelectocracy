...
[Stem cell biologist Bruce Lipton made the same point before corperate controlled academia was ready to hear it and he was exiled](https://youtu.be/t2Hx67Lv1oY?si=D7PO7bZ1sLpetE0_&t=1845)  
...
The genome is only a recipe book for making all our proteins but it contains no information about what organs are to be made or where they will be placed. Some of the information to make a human is defined by the few simple things that cells can do. The rest of the information is stored in the structure created by the bioelectric relationships between the cells (the bioelectric circuits).  
