...
How can these controls be decentralized so that no central powers can decide the target morphogenesis for the human macro-organism of which we are all a part? The answer is by transitioning to decentralized blockchain for money and finance, voting and governance, news and social media, identity management, and defense. But decentralized blockchain finance is already being captured by the central banks and the BlackRocks. So how can we reverse the damage and ensure that blockchain services remain decentralized? The answer is in understanding cancer and its cure at the level of organism and then applying what is known to the central banks and supporting blob.    
     
[Levin explains cancer in an organism and demonstrates a cure.](https://youtu.be/lIHUWOv4nkE?si=yipnr8uxzCT6ohv3&t=2761)   
 
### How to Apply Levin's cure for cancer to the central banks and supporting blob and, <br> How to help Mac reach its target form when no human knows what Mac is trying to become?  
